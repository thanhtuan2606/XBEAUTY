            ...
            <nav class="navbar navbar-expand-lg  ">
                <div class="container px-0 mx-0">
                  ...
                  <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
                    <a class="logo navbar-brand text-center" style="width: 250px" href="index.php"><img src="../content/img/logox.png" alt="" width="50%"></a>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-uppercase">
                      ...
                      <li class="nav-item">
                        <a class="nav-link text-black" href="?mod=page&act=category&id=4">Ưu đãi Hot</a>
                      </li>
                    </ul>
